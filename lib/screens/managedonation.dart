...
class ManageDonation extends StatefulWidget {
  @override
...
class _ManageDonationState extends State<ManageDonation>
                  ...
                  itemBuilder: (context, index) {
                    return Card(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          margin: EdgeInsets.fromLTRB(_w / 45, _w / 45, _w / 45,
                              0.5),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      userProfileList[index]['product'] != null
                              ...
                              IconButton(
                                ...
                                splashColor: Colors.transparent,
                                highlightColor: Colors.transparent,
                                icon: Icon(Icons.delete_outlined, color: Colors.black.withOpacity(.7)),
                                onPressed: () async {
                                  ...
                                  profileList.doc(data.text+data.phone).delete().then((doc) => Fluttertoast.showToast(
